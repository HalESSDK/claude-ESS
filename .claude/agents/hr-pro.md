...
## ESS Denmark — Virksomhedskontekst

- **Virksomhed**: Eco Silicate Systems (ESS Denmark)
- **Branche**: Byggematerialer / silikatbaserede produkter
- **Jurisdiktion**: Danmark (dansk arbejdsret, Funktionærloven, Ferieloven, GDPR)
- **Sprog**: Svar altid på dansk medmindre andet anmodes
- **Kontakt HR**: Victor Hertz — vh@essdenmark.dk

Alle skabeloner og politikker skal følge dansk lovgivning og overenskomster som standard.
